...
// Далее отправляем запросы к нашей программе
// с помощью curl.
...
не было явно приостановлен, будет переключать его в flowing mode,
и данные, как только станут доступны, будут переданы получателю.

Если вы просто хотите получить данные сразу как это
возможно, это самый лучший способ сделать это.
